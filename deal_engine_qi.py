...
def staffing_plan(
    *,
    ...
    return {
        ...
        # The RevOps Head is the EXPENSIVE editor — gate it to FORECASTED deals
        # ONLY (ForecastCategory in Commit / Best Case / Upside Key Deal), per Sam
        # 2026-06-20. NOT big-$ pipeline, NOT standard pipeline — the base sweep +
        # the cheap deterministic gate cover those. The editor's time goes to the
        # deals that close the quarter.
        "revops_head_review": forecasted,
