...
TASKS = int(sys.argv[sys.argv.index("--tasks") + 1]) if "--tasks" in sys.argv else 6
CONC = int(sys.argv[sys.argv.index("--conc") + 1]) if "--conc" in sys.argv else 18
BLUE = "mase-api-blue"

DEALS = [
    ("Bandhan Bank", "006P700000H55TV"), ("Gamuda", "006P700000Q15OU"), ("FGV", "0066700000yP7lZ"),
    ("NORTHPORT", "006P700000QFJwD"), ("Bank Rakyat", "006P700000YK67N"), ("EPF Malaysia", "006P700000Wkphs"),
    ("Cebu Pacific", "0066700000wdNe1"), ("International SOS", "006P700000YJlu7"), ("Nidec", "006P700000VnWhf"),
    ("HK Jockey Club", "006P700000YN6Nh"), ("Temasek", "006P700000BV2eA"), ("WIK Group", "006P700000Uxmk7"),
    ("HAECO", "006P700000NwbBd"), ("MTR", "006P700000KTTO5"), ("SATS", "006P700000Ltf02"),
    ("Changi Airport", "006P700000FEVJR"), ("Angel One", "006P700000aED8o"), ("Vodafone Idea", "006P700000ZxAjy"),
    ("Thiess", "006P700000WXMP7"), ("Civeo Corporation", "006P700000YC92N"), ("CIVEO PTY LTD", "006P700000YO8aM"),
    ("PNG Nat Procurement", "006P700000Eo6QN"), ("Port Authority NSW", "006P700000YlMxa"), ("Techtronic", "006P700000GWfrf"),
    ("Scheme Financial", "006P700000QKfzN"), ("WA DOJ", "006P700000Ly6Mb"), ("AusNet", "006P700000Nh2xS"),
    ("Dominos Pizza", "006P700000X6hvK"), ("Orascom", "006P700000Y1Ont"), ("Fly Dubai", "006P700000PIlWk"),
    ("ASYAD", "006P700000Z98IL"), ("Arabian Industries", "006P700000QvP7Z"), ("Khansaheb", "006P700000LtIUv"),
    ("Wheelson/Mumtalakat", "006P700000VlPdp"), ("SAMI", "006P700000RD9Ir"), ("Alghanim", "006P700000OUsd6"),
    ("DWTC", "006P700000MB1SN"),
]
...
print("=" * 92)
with open("fleet37_inproc_results.csv", "w", newline="", encoding="utf-8-sig") as fh:
    w = csv.writer(fh)
...
print(f"\n{ok}/{len(DEALS)} governed OK. wrote fleet37_inproc_results.csv")
print("FLEET37-INPROC-DONE")
