...
```json
{
  ...
  "ai": {
    ...
    "eb_engagement": {"name": "", "strength": "direct|indirect|field_only|none",
      "face_time": false, "last_contact": "YYYY-MM-DD or null", "source": ""},
