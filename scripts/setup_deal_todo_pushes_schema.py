"""One-off / idempotent: create the deal_todo_pushes table (Deal Engine Espresso
to-do -> Salesforce push ledger), enable Supabase realtime on it, and grant
...
Run: python3 scripts/setup_deal_todo_pushes_schema.py
"""
import os
import sys
...
SQL_PATH = os.path.join(_HERE, "..", "migrations", "0007_deal_todo_pushes.sql")

_TABLES = ["deal_todo_pushes"]
...
if __name__ == "__main__":
    ...
    print("[DONE] deal_todo_pushes schema ready")
